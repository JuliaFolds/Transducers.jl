...

{
    ...
    "title": "Base.foldl",
    "category": "function",
    "text": "foldl(step, xf::Transducer, init, itr)\nfoldl(step, ed::Eduction, init)\n\nThe first form is a shorthand for mapfoldl(xf, Completing(step), init, itr).  It is intended to be used with do block.  It is also equivalent to foldl(step, eduction(xf, itr), init).\n\nExamples\n\njulia> using Transducers\n\njulia> foldl(Filter(isodd), 0.0, 1:4) do state, input\n           @show state, input\n           state + input\n       end\n(state, input) = (0.0, 1)\n(state, input) = (1.0, 3)\n4.0\n\n\n\n\n\n"
},
